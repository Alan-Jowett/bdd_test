...
**Resulting BDD**:
![Simple BDD](../test_expressions/default_ordering/simple_expression_bdd.png)
...
![4-Queens Default BDD](../test_expressions/default_ordering/four_queens_bdd.png)
...
![4-Queens BDD](../test_expressions/default_ordering/four_queens_bdd.png)
...
![Filter Expression Tree](../test_expressions/default_ordering/filter_expression_expression_tree.png)

**Generated BDD Structure**:
![Filter Expression BDD](../test_expressions/default_ordering/filter_expression_bdd.png)
...
void walk_dag(const NodeType& root, Iterator iter, WalkConfig config = {});
```
